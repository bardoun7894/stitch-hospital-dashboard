...
<head>
    ...
    <title>{{ __('messages.set_new_password') }} - {{ __('messages.app_name') }}</title>
        ...
        <div class="p-8 sm:p-10">
            ...
            <form class="space-y-6" action="{{ route('password.update') }}" method="POST">
                ...
                <div class="space-y-5">
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                readonly
                                value="{{ $email }}"
                                class="w-full pl-10 pr-4 py-3 bg-gray-100 dark:bg-slate-800/60 border border-gray-200 dark:border-slate-700 rounded-xl text-text-sub-light dark:text-text-sub-dark cursor-not-allowed outline-none"
                            >
                        </div>
                    </div>
                    ...
                    <!-- New Password -->
                    <div class="group">
                        <label for="password" class="block text-sm font-medium text-text-main-light dark:text-white mb-1.5 ml-1">
                    ...
                    <div class="group">
                        <label for="password_confirmation" class="block text-sm font-medium text-text-main-light dark:text-white mb-1.5 ml-1">
