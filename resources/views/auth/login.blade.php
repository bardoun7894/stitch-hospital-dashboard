    ...
    <div class="w-full max-w-md bg-white dark:bg-surface-dark rounded-3xl overflow-hidden relative z-10 animate-fade-in-up mx-auto border border-gray-200 dark:border-gray-700 shadow-xl">
        ...
        <div class="p-8 sm:p-10">
            ...
            <div class="text-center mb-8">
                <div class="mx-auto size-16 flex items-center justify-center rounded-2xl bg-gradient-to-br from-primary/10 to-indigo-500/10 text-primary text-4xl font-bold mb-6 shadow-sm border border-primary/10">
                    S
                </div>
            ...
            <form class="space-y-6" action="{{ route('login.submit') }}" method="POST">
                ...
                <div class="space-y-5">
                    ...
                    <div class="group">
                        <div class="flex items-center justify-between mb-1.5 ml-1">
                            ...
                            <a href="{{ route('password.request') }}" class="text-sm font-medium text-primary hover:text-indigo-500 transition-colors">
                                {{ __('messages.forgot_password') }}
                            </a>
                        </div>
                         <div class="relative">
                            <span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-text-sub-light/50 transition-colors group-focus-within:text-primary pointer-events-none">lock</span>
                            <input 
                                id="password" 
                                name="password" 
                                type="password" 
                ...
                <div class="flex items-center ml-1">
                    <label class="inline-flex items-center cursor-pointer">
                        ...
                        <div class="relative w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-primary/20 dark:peer-focus:ring-primary/30 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-primary"></div>
                        <span class="ml-2 text-sm text-text-sub-light dark:text-text-sub-dark">{{ __('messages.remember_me') }}</span>
                    </label>
                </div>
            ...
            <div class="mt-8 flex flex-col items-center gap-6">
                ...
                <p class="text-sm text-text-sub-light dark:text-text-sub-dark text-center">
                    {{ __('messages.want_to_register_hospital') }}
                    <a href="{{ route('hospital.register') }}" class="font-bold text-primary hover:text-indigo-500 transition-colors hover:underline decoration-2 underline-offset-4">{{ __('messages.register_hospital') }}</a>
                </p>
